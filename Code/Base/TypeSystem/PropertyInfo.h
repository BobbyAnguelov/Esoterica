...
namespace EE::TypeSystem
{
    ...
    public:
        ...
        inline bool IsTypeInstanceProperty() const { return m_flags.IsFlagSet( Flags::IsTypeInstance ); }
        ...
        inline bool IsResourcePtrProperty() const { return m_flags.IsFlagSet( Flags::IsResourcePtr ); }
    ...
    public:
        ...
        int32_t                     m_size = -1;                            // Byte size of property / total array byte size for static array properties
        ...
        int32_t                     m_arrayElementSize = -1;                // Byte size of an individual array element
