...
namespace EE::Serialization
{
    ...
    class EE_BASE_API BinaryReader final
    {
    public:
    ...
    class EE_BASE_API BinaryWriter final
    {
    public:
    ...
    class EE_BASE_API BinaryInputArchive final : public Internal::Archive<BinaryReader>
    {
    public:
    ...
    class EE_BASE_API BinaryOutputArchive final : public Internal::Archive<BinaryWriter>
    {
    public:
