...
#include "Base/ThirdParty/rapidjson/prettywriter.h"
...
namespace EE::Serialization
{
    ...
    EE_BASE_API char const* GetJsonErrorMessage( rapidjson::ParseErrorCode code );

    // File reader
    //-------------------------------------------------------------------------

    class EE_BASE_API JsonArchiveReader
    {
    public:
    ...
    class EE_BASE_API JsonArchiveWriter
    {
    public:
