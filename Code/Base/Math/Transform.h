...
namespace EE
{
    ...
    public:
        ...
        // Fast but unchecked setter - use at own risk!!!
        EE_FORCE_INLINE static void DirectlySetRotation( Transform& transform, Quaternion&& rotation ) { transform.m_rotation = rotation; }

        // Fast but unchecked setter - use at own risk!!!
        EE_FORCE_INLINE static void DirectlySetRotation( Transform& transform, Quaternion const& rotation ) { transform.m_rotation = rotation; }

        // Fast but unchecked setter - use at own risk!!!
        EE_FORCE_INLINE static void DirectlySetTranslationScale( Transform& transform, Vector&& translationScale ) { transform.m_translationScale = translationScale; }

        // Fast but unchecked setter - use at own risk!!!
        EE_FORCE_INLINE static void DirectlySetTranslationScale( Transform& transform, Vector const& translationScale ) { transform.m_translationScale = translationScale; }
    ...
    public:
        ...
        EE_FORCE_INLINE Vector const& GetTranslationAndScale() const { return m_translationScale; }
        ...
        EE_FORCE_INLINE void SetTranslationAndScale( Vector const& newTranslationScale ) { EE_ASSERT( newTranslationScale.GetW() != 0.0f ); m_translationScale = newTranslationScale; }
