...
namespace EE::ImGuiX
{
    namespace Platform
    {
        ...
        static void ImGui_ImplWin32_SetWindowTitle( ImGuiViewport* viewport, const char* title )
        {
            ...
            InlineString str( title );
            str.erase( eastl::remove_if( str.begin(), str.end(), [] ( char c ) { return !( c >= 0 && c < 128 ); } ), str.end() );
            str.trim();
    ...
    void ImguiSystem::InitializePlatform()
    {
        ...
        if ( io.ConfigFlags & ImGuiConfigFlags_ViewportsEnable )
        {
            ...
            auto pApplication = reinterpret_cast<Win32Application*>( ::GetWindowLongPtrW( pBackendData->hWnd, GWLP_USERDATA ) );
