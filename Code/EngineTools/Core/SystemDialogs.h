...
namespace EE
{
    namespace TypeSystem { class TypeID; }
    class ToolsContext;
    ...
    public:
        ...
        [[nodiscard]] static Result LoadResourceOrDataFile( ToolsContext const* pToolsContext, FileSystem::Extension extension, FileSystem::Path const& startingPath = FileSystem::Path() );
        [[nodiscard]] static Result LoadResourceOrDataFile( ToolsContext const* pToolsContext, TypeSystem::TypeID typeID, FileSystem::Path const& startingPath = FileSystem::Path() );
        ...
        [[nodiscard]] static Result SaveResourceOrDataFile( ToolsContext const* pToolsContext, FileSystem::Extension extension, FileSystem::Path const& startingPath = FileSystem::Path() );
        [[nodiscard]] static Result SaveResourceOrDataFile( ToolsContext const* pToolsContext, TypeSystem::TypeID typeID, FileSystem::Path const& startingPath = FileSystem::Path() );
    };
    ...
    public:
        ...
        static bool Confirmation( Severity severity, String const& title, char const* pMessageFormat, ... )
        {
            ...
            return ShowInternal( severity, Type::YesNo, title, message ) == Result::Yes;
        }
