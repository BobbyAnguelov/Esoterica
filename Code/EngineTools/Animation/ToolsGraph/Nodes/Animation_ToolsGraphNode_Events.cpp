...
namespace EE::Animation::GraphNodes
{
    ...
    void IDEventToolsNode::DrawInfoText( VisualGraph::DrawContext const& ctx )
    {
    ...
    void IDEventPercentageThroughToolsNode::DrawInfoText( VisualGraph::DrawContext const& ctx )
    {
