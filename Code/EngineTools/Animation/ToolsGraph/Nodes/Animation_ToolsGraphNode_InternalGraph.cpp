#include "Animation_ToolsGraphNode_InternalGraph.h"
...
{
    InternalReferencedGraphToolsNode::InternalReferencedGraphToolsNode()
    ...
    int16_t InternalReferencedGraphToolsNode::Compile( GraphCompilationContext& context ) const
    {
        ...
        {
            auto pData = GetResolvedVariationDataAs<InternalReferencedGraphToolsNode::Data>( context.GetVariationHierarchy(), context.GetVariationID() );
    ...
    void InternalReferencedGraphToolsNode::DrawContextMenuOptions( NodeGraph::DrawContext const& ctx, NodeGraph::UserContext* pUserContext, Float2 const& mouseCanvasPos, NodeGraph::Pin* pPin )
    {
    ...
    ResourceID InternalReferencedGraphToolsNode::GetReferencedGraphResourceID( VariationHierarchy const& variationHierarchy, StringID variationID ) const
    {
