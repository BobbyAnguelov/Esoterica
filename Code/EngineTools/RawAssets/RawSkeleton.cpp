...
namespace EE::RawAssets
{
    ...
    bool RawSkeleton::IsChildBoneOf( int32_t parentBoneIdx, int32_t childBoneIdx ) const
    {
    ...
    void RawSkeleton::Finalize( TVector<StringID> const& highLODBones )
    {
        ...
        else
        {
            ...
            for ( int32_t i = 0; i < (int32_t) finalSetOfHighLODBones.size(); i++ )
            {
                ...
                else
                {
                    ...
                    else // Add to index list and ensure all children of this bone are in the high LOD list
                    {
            ...
            TVector<BoneData> reorderedBoneData;
