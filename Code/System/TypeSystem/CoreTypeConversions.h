...
{
    EE_SYSTEM_API bool ConvertStringToNativeType( TypeRegistry const& typeRegistry, TypeID typeID, TypeID templateArgumentTypeID, String const& strValue, void* pValue );
    EE_SYSTEM_API bool ConvertNativeTypeToString( TypeRegistry const& typeRegistry, TypeID typeID, TypeID templateArgumentTypeID, void const* pValue, String& strValue );
    EE_SYSTEM_API bool ConvertBinaryToNativeType( TypeRegistry const& typeRegistry, TypeID typeID, TypeID templateArgumentTypeID, Blob const& byteArray, void* pValue );
    EE_SYSTEM_API bool ConvertNativeTypeToBinary( TypeRegistry const& typeRegistry, TypeID typeID, TypeID templateArgumentTypeID, void const* pValue, Blob& byteArray );
    EE_SYSTEM_API bool ConvertStringToBinary( TypeRegistry const& typeRegistry, TypeID typeID, TypeID templateArgumentTypeID, String const& strValue, Blob& byteArray );
    EE_SYSTEM_API bool IsValidStringValueForType( TypeRegistry const& typeRegistry, TypeID typeID, TypeID templateArgumentTypeID, String const& strValue );
    ...
    EE_SYSTEM_API void StringToFloatArray( String const& str, int32_t const numFloats, float* pFloats );

    // Convert an array of floats into a comma separated string of floats
    EE_SYSTEM_API void FloatArrayToString( float const* pFloats, int32_t const numFloats, String& strValue );

    // Convert a comma separated string of ints into an array of ints
    EE_SYSTEM_API void StringToIntArray( String const& str, int32_t const numInts, int32_t* pInts );

    // Convert an array of ints into a comma separated string of ints
    EE_SYSTEM_API void IntArrayToString( int32_t const* pInts, int32_t const numInts, String& strValue );
}