...
namespace EE::Math
{
    ...
    class EE_SYSTEM_API ViewVolume
    {
    ...
    EE_SYSTEM_API Matrix CreatePerspectiveProjectionMatrix( float verticalFOV, float aspectRatio, float nearPlaneZ, float farPlaneZ );

    // Creates a right handed orthographic projection matrix
    EE_SYSTEM_API Matrix CreateOrthographicProjectionMatrix( float width, float height, float nearPlaneZ, float farPlaneZ );
}