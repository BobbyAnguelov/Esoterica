...
#include "System/ThirdParty/concurrentqueue/concurrentqueue.h"
#include <mutex>
...
namespace EE
{
    namespace Threading
    {
        ...
        EE_SYSTEM_API ProcessorInfo GetProcessorInfo();
        ...
        EE_SYSTEM_API bool IsMainThread();

        //-------------------------------------------------------------------------
        // Global State
        //-------------------------------------------------------------------------

        EE_SYSTEM_API void Initialize( char const* pMainThreadName );
        EE_SYSTEM_API void Shutdown();
        EE_SYSTEM_API ThreadID GetCurrentThreadID();
        EE_SYSTEM_API void SetCurrentThreadName( char const* pName );
    }
}