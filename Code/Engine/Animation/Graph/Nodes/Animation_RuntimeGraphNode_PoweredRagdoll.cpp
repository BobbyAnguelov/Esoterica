...
namespace EE::Animation
{
    ...
    void PoweredRagdollNode::CreateRagdoll( GraphContext& context )
    {
        ...
        m_pRagdoll->SetGravityScale( pNodeDefinition->m_isGravityEnabled );
    }
    ...
    GraphPoseNodeResult PoweredRagdollNode::UpdateRagdoll( GraphContext& context, GraphPoseNodeResult const& childResult )
    {
        ...
        int8_t const setPoseTaskIdx = context.GetTaskSystem()->RegisterTask<RagdollSetPoseTask>( GetNodePath( context ), m_pRagdoll, childResult.m_taskIdx, initOptions );
        ...
        result.m_taskIdx = context.GetTaskSystem()->RegisterTask<RagdollGetPoseTask>( GetNodePath( context ), m_pRagdoll, setPoseTaskIdx, physicsWeight );
        return result;
    }
}