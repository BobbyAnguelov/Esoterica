...
namespace EE
{
    ...
    bool DebugView::IsAnyWindowOpen() const
    {
    ...
    DebugView::Window* DebugView::GetWindow( StringID typeID )
    {
        for ( auto& window : m_windows )
        {
    ...
    DebugView::Window* DebugView::GetWindow( uint64_t userData )
    {
        for ( auto& window : m_windows )
        {
    ...
    DebugView::Window* DebugView::GetWindow( StringID typeID, uint64_t userData )
    {
        for ( auto& window : m_windows )
        {
