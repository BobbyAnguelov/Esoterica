...
namespace EE::Physics
{
    ...
    void MaterialRegistry::Initialize()
    {
        ...
        reinterpret_cast<uintptr_t&>( m_pDefaultMaterial->userData ) = m_defaultMaterialID.GetID();
    ...
    void MaterialRegistry::RegisterMaterials( TVector<MaterialSettings> const& materials )
    {
        ...
        for ( auto const& materialSettings : materials )
        {
            ...
            reinterpret_cast<uintptr_t&>( m_pDefaultMaterial->userData ) = materialSettings.m_ID.GetID();
