...
namespace EE
{
    void PlayerInputState::RegisterInputs()
    {
        ...
        RegisterInput( m_lockTarget );
        RegisterInput( m_timeDilation );
        ...
        m_lockTargetUpdater.m_ID = Input::InputID::Controller_LeftShoulder;
        m_timeDilationUpdater.m_ID = Input::InputID::Controller_LeftTrigger;
    ...
    void PlayerInputState::Update( Input::InputSystem const* pInputSystem, Seconds timeDelta, Seconds scaledTimeDelta )
    {
        ...
        UpdateSignal( m_lockTarget, m_lockTargetUpdater );
        UpdateSignal( m_timeDilation, m_timeDilationUpdater );
