...
namespace EE
{
    ...
    class NPCAnimationController final : public Animation::GraphController
    {
    public:

        NPCAnimationController( Animation::GraphComponent* pGraphComponent, Render::SkeletalMeshComponent* pMeshComponent );
    ...
    private:
        ...
        ControlParameter<bool>          m_hackIdle = "Idle";
