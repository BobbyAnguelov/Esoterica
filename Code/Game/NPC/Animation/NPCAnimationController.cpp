...
namespace EE
{
    NPCAnimationController::NPCAnimationController( Animation::GraphComponent* pGraphComponent, Render::SkeletalMeshComponent* pMeshComponent )
        : Animation::GraphController( pGraphComponent, pMeshComponent )
    {
        ...
        m_hackIdle.TryBind( this );
        m_hackIdle.Set( true );
    }

    void NPCAnimationController::SetCharacterState( CharacterAnimationState state )
    {
    ...
    void NPCAnimationController::HACK_SetIdle( bool isIdle )
    {
        m_hackIdle.Set( isIdle );
    }

    void NPCAnimationController::SetIdle()
    {
    ...
    void NPCAnimationController::SetLocomotionDesires( Seconds const deltaTime, Vector const& movementVelocityWS, Vector const& facingDirectionWS )
    {
