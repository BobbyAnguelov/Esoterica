...
#include "TypeReflection_ReflectedEnumConstant.h"
...
namespace EE::Reflection
{
    ...
    public:
        ...
        ReflectedType( TypeSystem::TypeID ID, String const& name );
    ...
    public:
        ...
        // Structures
        TypeSystem::TypeID                              m_parentID;
        TVector<ReflectedProperty>                      m_properties;

        // Enums
        TypeSystem::CoreTypeID                          m_underlyingType = TypeSystem::CoreTypeID::Uint8;
