    ...
    bool Generator::Generate( ReflectionDatabase const& database, SolutionInfo const& solution )
    {
        ...
        for ( auto& prj : solution.m_projects )
        {
            ...
            for ( auto& dirtyHeaderIdx : prj.m_dirtyHeaders )
            {
                ...
                String const typeInfoFilename = headerInfo.GetAutogeneratedTypeInfoFileName( autoGeneratedDirectory ).GetString();
            ...
            String const module_cpp = autoGeneratedDirectory.GetString() + Reflection::Settings::g_autogeneratedModuleFile;
