...
1. Download the [external dependencies](https://drive.google.com/file/d/1HMQkphOrBxQo-SeeCmN_isr-HexHUsc2/view?usp=sharing) and extract into the Esoterica root folder (X:/Esoterica Path/). You should end up with 'X:/Esoterica Path/External/'.
